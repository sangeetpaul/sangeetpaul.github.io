...
3. Install extension LaTeX Workshop in VS Code: <https://marketplace.visualstudio.com/items?itemName=James-Yu.latex-workshop>
4. Download the aforementioned git repo as zip: <https://github.com/unofficial-uoregon-dissertation-formats/unofficial-uoregon-grad-school-dissertation-latex-markdown-apa-format>
5. Extract zip
